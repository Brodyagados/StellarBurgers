...
export const SET_INGREDIENT_DETAIL: 'INGREDIENT_DETAIL/SET_INGREDIENT_DETAIL' = 'INGREDIENT_DETAIL/SET_INGREDIENT_DETAIL';
export const REMOVE_INGREDIENT_DETAIL: 'INGREDIENT_DETAIL/REMOVE_INGREDIENT_DETAIL' =
  'INGREDIENT_DETAIL/REMOVE_INGREDIENT_DETAIL';
